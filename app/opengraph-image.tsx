      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Calcula una cuota mensual sin cobrar a ciegas
            </div>
            <div
              style={{
                display: 'flex',
          ...
          >
            {['Horas incluidas', 'Buffer', 'IVA aparte'].map((label) => (
              <div
                key={label}
                style={{
                  display: 'flex',
        ...
        >
          {[
            ...
            ['Cuota minima', 'Antes de margen y sin venderte corto'],
            ['Cuota final', 'Con buffer e IVA aparte si aplica'],
          ].map(([title, text]) => (
            <div
              key={title}
              style={{
